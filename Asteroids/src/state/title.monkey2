	...
	Method Render:Void(canvas:Canvas, tween:Double) Override
		...
		Select _status
			...
			Case TitleStatus.Points
				...
				If (_stateCounterTimer.Counter>200) VectorFont.DrawFont(canvas,"    200 POINTS",320,2.0)	
				If (_stateCounterTimer.Counter>250) VectorFont.DrawFont(canvas,"   1000 POINTS",360,2.0)	
